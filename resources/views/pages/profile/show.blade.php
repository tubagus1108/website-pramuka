        ...
        <nav class="flex mb-4 md:mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm">
                ...
                <li>
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
                        <span class="text-blue-700 font-semibold">{{ $menu->title }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <article class="bg-white rounded-lg shadow-md p-5 md:p-8">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <a href="/profile" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-semibold text-sm transition">
